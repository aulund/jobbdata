...
class VariantInfoCollector:
    ...
    def create_widgets(self):
        ...
        # Use translations for zygosity, inheritance, and ACMG criteria
...
def autofill_gene_data(self, event):
    ...
    if gene in self.new_genes:
        ...
        self.data['Disease'] = self.gene_diseases.get(gene, 'Disease not available')
    else:
        self.data['Transcript'] = 'Transcript not available'
        self.data['Disease'] = 'Disease not available'
