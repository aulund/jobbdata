...
from general_info import GeneralInfo  # Importerar GeneralInfo
from variant_info import VariantInfo  # Importerar VariantInfo
...
def main():
    ...
    genes_file = 'H:/pythonmall/gen_utr_GUI_2.0/new_genes.json'
